...
parkings <- rbind(
  ...
  data.frame(
    ...
    "ident" = c("CUBPK105", "CUBPK102", "CUBPK33", "CUBPK78", "CUBPK04", "CUBPK19", "CUBPK100", "CUBPK80", "CUBPK95", "CUBPK27", "CUBPK35", "CUBPK36", "CUBPK14", "CUBPK81", "CUBPK94", "CUBPK85", "CUBPK103", "CUBPK104"),
    "parc_relais" = FALSE
  ),
  data.frame(
